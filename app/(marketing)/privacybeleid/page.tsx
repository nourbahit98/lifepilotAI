...
export default function PrivacyPage() {
  return (
    <main>
      <SiteHeader />
      <article className="mx-auto max-w-3xl px-5 py-16 leading-7 text-neutral-700 sm:px-8">
        <h1 className="text-4xl font-semibold text-neutral-950">Privacybeleid</h1>
        <p className="mt-6">
        ...
        <h2 className="mt-8 text-xl font-semibold text-neutral-950">Gegevens en toestemming</h2>
        <p className="mt-3">
        ...
        <h2 className="mt-8 text-xl font-semibold text-neutral-950">AI-verwerking</h2>
        <p className="mt-3">
