  ...
  return (
    <main>
      ...
      <section className="mx-auto grid min-h-[calc(100vh-64px)] max-w-7xl gap-8 px-5 py-12 sm:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        <div>
          <h2 className="text-4xl font-semibold text-slate-950">Start met LifePilot AI.</h2>
        ...
        <Suspense fallback={<div className="text-sm text-slate-600">Registratieformulier laden...</div>}>
