    ...
    <>
      <section className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:py-24">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mt-5 text-balance text-5xl font-semibold leading-[1.04] text-neutral-950 sm:text-6xl lg:text-7xl">
          ...
          <CardContent>
            <div className="grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
              <div className="rounded-lg border border-neutral-200 bg-neutral-50 p-5">
                <p className="text-sm font-semibold text-neutral-950">Vraag aan LifePilot</p>
      ...
      <section className="border-y border-neutral-200 bg-white px-5 py-16 sm:px-8" id="functies">
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            <Badge>Functies</Badge>
            <h2 className="mt-4 text-4xl font-semibold text-neutral-950">Alles vanuit één centrale invoer.</h2>
          </div>
...
export function PricingSection() {
  return (
    <section className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:py-24" id="prijzen">
      <div className="max-w-3xl">
        <Badge>Prijzen</Badge>
        <h2 className="mt-4 text-4xl font-semibold text-neutral-950">Transparante abonnementen.</h2>
        <p className="mt-4 text-neutral-600">Jaarlijks betalen geeft ongeveer 20% korting.</p>
      </div>
          ...
          <Card className={plan.badge ? "border-neutral-300 bg-neutral-50" : ""} key={plan.id}>
            <CardContent>
              <div className="flex items-start justify-between gap-4">
                <div>
                  <h3 className="text-xl font-semibold text-neutral-950">{plan.name}</h3>
                  <p className="mt-2 text-sm leading-6 text-neutral-600">{plan.description}</p>
                </div>
                {plan.badge ? <Badge>{plan.badge}</Badge> : null}
              </div>
              <p className="mt-6 text-3xl font-semibold text-neutral-950">
                {priceLabel(plan.monthly, "monthly")}
              </p>
              <p className="mt-1 text-sm text-neutral-500">{priceLabel(plan.yearly, "yearly")}</p>
              <ul className="mt-6 space-y-3">
                {plan.benefits.map((benefit) => (
                  <li className="text-sm leading-6 text-neutral-700" key={benefit}>
                    {benefit}
                  </li>
                ))}
              </ul>
