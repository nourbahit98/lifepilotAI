    ...
    <>
      <section>
        ...
        <div className="mt-6 rounded-lg border border-neutral-200 bg-white p-5 shadow-sm">
          <p className="text-sm font-semibold text-neutral-950">Vraag LifePilot om iets te regelen...</p>
      ...
      <section className="grid gap-5 lg:grid-cols-3">
        ...
        <Card>
          <CardHeader>
            <h2 className="text-base font-semibold text-neutral-950">Gebruik</h2>
          </CardHeader>
          <CardContent>
    ...
    <Card>
      ...
      <CardContent>
        <ul className="space-y-3">
          {items.map((item) => (
            <li className="rounded-lg bg-neutral-50 px-4 py-3 text-sm text-neutral-600" key={item}>
              {item}
            </li>
          ))}
        </ul>
